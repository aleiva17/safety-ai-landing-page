  ...
  return (
    <form className="bg-[#1a202c] flex flex-col max-w-full px-9 md:px-10 pt-10 rounded-3xl gap-4">
      <div className="flex flex-wrap md:flex-nowrap justify-between gap-4">
        ...
        <input onChange={ (event) => handleOnChangeNameInput(event.target.value) } className="w-full md:w-72 max-w-72 rounded-full py-1 px-3" type="text" name="name" value={ name } />
      </div>
      <div className="flex flex-wrap md:flex-nowrap justify-between gap-4">
        <label className="text-white text-xl" htmlFor="phone">Celular</label>
        <input onChange={ (event) => handleOnChangePhoneInput(event.target.value) } className="w-full md:w-72 max-w-72 rounded-full py-1 px-3" type="number" name="phone" value={ phone } />
      </div>
      <div className="flex flex-wrap md:flex-nowrap justify-between gap-4">
        <label className="text-white text-xl" htmlFor="email">Correo</label>
        <input onChange={ (event) => handleOnChangeEmailInput(event.target.value) } className="w-full md:w-72 max-w-72 rounded-full py-1 px-3" type="email" name="email" value={ email } />
      </div>
      <div className="flex flex-wrap md:flex-nowrap flex-col justify-between gap-4">
        ...
        <textarea onChange={ (event) => handleOnChangeMessageInput(event.target.value) } className="rounded-xl py-2 px-2 w-full" name="message" rows={4} value={ message }></textarea>
      </div>
